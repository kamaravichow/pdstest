...
static void my_application_activate(GApplication* application) {
  ...
  // Kiosk / panel mode: no title bar, no window chrome, edge-to-edge fullscreen.
  ...
  // Enter fullscreen after realize so the compositor applies it reliably on
  // X11/Wayland (Raspberry Pi panels, GNOME, labwc, etc.).
